...
<head>
    ...
    <link href="../HeaderAndFooter/Navbar.jsp" rel="stylesheet"/>
        ...
        <div class="col-4 custom-col-3" style="margin-top: 3cm;">
            <div class="card custom-col-3" style="width: 18rem;">
                ...
                <div class="card-body">
                    ...
                    <a href="../UserPages/DetailedInformationsCarPage.jsp?carId=<%=carId%>&carName=<%=carName%>"  class="btn btn-primary">Explore this car!</a>
